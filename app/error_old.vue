    ...
    <div class="error-container">
      <div class="error-content">
        ...
        <div class="error-actions">
          <button color="success" size="lg" @click="handleError">Volver al inicio</button>

          <button color="primary" size="lg" variant="ghost" @click="goBack">Ir atrás</button>
        </div>
...
<style scoped>
  ...
  @keyframes glitch {
    ...
    25% {
      text-shadow: -2px 0 20px rgba(0, 220, 130, 0.5), 2px 2px 20px rgba(0, 220, 130, 0.3);
    }
    50% {
      text-shadow: 2px -2px 20px rgba(0, 220, 130, 0.5), -2px 2px 20px rgba(0, 220, 130, 0.3);
    }
    75% {
      text-shadow: -2px 2px 20px rgba(0, 220, 130, 0.5), 2px -2px 20px rgba(0, 220, 130, 0.3);
    }
