<script setup lang="ts">
  const testimonials = ref([
    ...
    },
    {
      ...
      quote: 'La calidad es increíble por el precio. Sin duda volveré a comprar en esta tienda.',
    },
    {
      user: {
        stars: 3,
    ...
    },
    {
      ...
      quote: 'El envío fue rápido y el producto llegó bien embalado. Volveré a comprar aquí.',
    },
    {
      user: {
        stars: 1,
      ...
      quote: 'Gran experiencia de compra, producto tal cual la descripción y de muy buena calidad.',
    },
    {
      user: {
        stars: 1,
    ...
    },
    {
      ...
      quote: 'Muy feliz con mi compra. El producto funciona perfecto y la atención fue genial.',
    },
    {
      user: {
        stars: 5,
    ...
    },
    {
      ...
      quote: 'Me sorprendió la calidad. El envío también fue muy rápido. ¡Gracias!',
    },
  ]);
</script>
    ...
    <div class="flex items-center justify-between gap-3">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-gray-600 text-sm">Nuestras reseñas de clientes satisfechos.</p>
        </div>
      </div>
      <!-- <UButton
        color="primary"
